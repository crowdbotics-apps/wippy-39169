"""
Django settings for wippy_39169 project.
...
WSGI_APPLICATION = 'wippy_39169.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wippy_39169 API",
    "DESCRIPTION": "API documentation for wippy_39169 App",
    "VERSION": "v1",
}
